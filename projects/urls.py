...
urlpatterns = [
    ...
    url(r'^(?P<pk>[0-9]+)/add-language/$', LanguageCreateView.as_view(), name='language_create'),
    url(r'^(?P<pk>[0-9]+)/add-image/$', ProjectScreenShotCreateView.as_view(), name='image_create'),
